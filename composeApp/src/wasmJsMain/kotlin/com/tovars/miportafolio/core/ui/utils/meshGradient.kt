package com.tovars.miportafolio.core.ui.utils
...
fun Modifier.radialGradientsBackground() = drawBehind {
    ...
    drawCircle(
        brush = Brush.radialGradient(
            colors = listOf(
                Color(0xD9FFE066), // hsla(55, 93%, 54%, 0.85)
                Color.Transparent
            ),
            center = Offset(width * 0.96f, height * 0.96f),
            radius = width * 0.86f
        ),
        center = Offset(width * 0.96f, height * 0.96f),
        radius = width * 0.86f
    ...
    drawCircle(
        brush = Brush.radialGradient(
            colors = listOf(
                Color(0xFF92A7F1), // hsla(229, 71%, 68%, 1)
                Color.Transparent
            ),
    ...
    drawCircle(
        brush = Brush.radialGradient(
            colors = listOf(
                Color(0xFFFF3DD8), // hsla(308, 93%, 51%, 1)
                Color.Transparent
            ),
            center = Offset(width * 0.57f, height * 0.73f),
            radius = width * 0.89f
        ),
        center = Offset(width * 0.57f, height * 0.73f),
        radius = width * 0.89f
    ...
    drawCircle(
        brush = Brush.radialGradient(
            colors = listOf(
                Color(0xFFFFA1E0), // hsla(318, 60%, 76%, 1)
                Color.Transparent
            ),
            center = Offset(width * 0.20f, height * 0.04f),
            radius = width * 0.56f
        ),
        center = Offset(width * 0.20f, height * 0.04f),
        radius = width * 0.56f
    ...
    drawCircle(
        brush = Brush.radialGradient(
            colors = listOf(
                Color(0xFFFF47A4), // hsla(324, 92%, 59%, 1)
                Color.Transparent
            ),
            center = Offset(width * 0.74f, height * 0.15f),
            radius = width * 0.57f
        ),
        center = Offset(width * 0.74f, height * 0.15f),
        radius = width * 0.57f
